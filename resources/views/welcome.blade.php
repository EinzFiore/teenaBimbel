...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- css files -->
    <link href="<?= url('childWeb/css/bootstrap.css') ?>" rel='stylesheet' type='text/css' /><!-- bootstrap css -->
    <link href="<?= url('childWeb/css/style.css')?>" rel='stylesheet' type='text/css' /><!-- custom css -->
	<link href="<?= url('childWeb/css/css_slider.css') ?>" type="text/css" rel="stylesheet" media="all">
    <link href="<?= url('childWeb/css/font-awesome.min.css') ?>" rel="stylesheet"><!-- fontawesome css -->
	<!-- //css files -->
...
<header>
	...
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="index.html"><img src="images/s2.png" alt=""> Teena Bimbel </a></h1>
			</div>
...
<section class="services py-5" id="services">
	<div class="container">
		...
		<div class="row ml-sm-5">
				...
				<div class="our-services-wrapper mb-60">
					<div class="services-inner">
						<div class="our-services-img">
							<img src="<?= url('childWeb/images/s1.png') ?>" alt="">
						</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
				<div class="our-services-wrapper mb-60">
					<div class="services-inner">
						<div class="our-services-img">
							<img src="<?= url('childWeb/images/s2.png') ?>" alt="">
						</div>
						<div class="our-services-text">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
				<div class="our-services-wrapper mb-60">
					<div class="services-inner">
						<div class="our-services-img">
							<img src="<?= url('childWeb/images/s3.png') ?>" alt="">
						</div>
						<div class="our-services-text">
							<h4>Ac Classrooms</h4>
							<p>Proin varius pellentesque nunc tincidunt ante. Init id lacus</p>
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
				<div class="our-services-wrapper mb-60">
					<div class="services-inner">
						<div class="our-services-img">
							<img src="<?= url('childWeb/images/s4.png') ?>" alt="">
						</div>
						<div class="our-services-text">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
				<div class="our-services-wrapper mb-60">
					<div class="services-inner">
						<div class="our-services-img">
							<img src="<?= url('childWeb/images/s5.png') ?>" alt="">
						</div>
						<div class="our-services-text">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
				<div class="our-services-wrapper mb-60">
					<div class="services-inner">
						<div class="our-services-img">
							<img src="<?= url('childWeb/images/s6.png') ?>" alt="">
						</div>
						<div class="our-services-text">
							<h4>Library Books</h4>
							<p>Proin varius pellentesque nunc tincidunt ante. Init id lacus</p>
		...
		<div class="position-image">
			<img src="<?= url('childWeb/images/services.png') ?>" alt="" class="img-fluid">
		</div>
		<!-- //positioned image -->
	</div>
</section>
...
<section class="other_services py-5" id="why">
	<div class="container py-lg-5 py-3">
		<h3 class="heading mb-sm-5 mb-4">Pilihan Paket </h3>
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="grid">
					<img src="<?= url('childWeb/images/choose1.jpg') ?>" alt="" class="img-fluid" />
					<div class="info p-4">
						<h4 class=""><img src="<?= url('childWeb/images/s1.png') ?>" class="img-fluid" alt="">Reguler</h4>
						<p class="mt-3">Onec consequat sapien amet leo cur sus rhoncus. Nullam dui mi Donec at nunc enim. Proin at iaculis tellus...</p>
						<p><strong>Rp. 300,000 - 500,000</strong></p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-md-0 mt-4">
				<div class="grid">
					<img src="<?= url('childWeb/images/choose2.jpg') ?>" alt="" class="img-fluid" />
					<div class="info p-4">
						<h4 class=""><img src="<?= url('childWeb/images/s3.png') ?>" class="img-fluid" alt="">Premium</h4>
						<p class="mt-3">Onec consequat sapien amet leo cur sus rhoncus. Nullam dui mi Donec at nunc enim. Proin at iaculis tellus...</p>
						<p><strong>Rp. 500,000 - 700,000</strong></p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
				<div class="grid">
					<img src="<?= url('childWeb/images/choose3.jpg')?>" alt="" class="img-fluid" />
					<div class="info p-4">
						<h4 class=""><img src="<?= url('childWeb/images/s5.png') ?>" class="img-fluid" alt="">Platinum</h4>
						<p class="mt-3">Onec consequat sapien amet leo cur sus rhoncus. Nullam dui mi Donec at nunc enim. Proin at iaculis tellus...</p>
						<p><strong>Rp. 1000,000 - 150,0000</strong></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container py-md-3">
			<div class="footer-grid_section text-center">
				<div class="footer-title mb-3">
					<a href="#"><img src="images/s2.png" alt="">Teena Bimbel</a>
				</div>
	...
	<div class="container py-4">
		<div class="row bottom">
			...
			<div class="col-lg-6 copy-right p-0">
				<p class="">© 2020 Teena Bimbel. All rights reserved | Design by
